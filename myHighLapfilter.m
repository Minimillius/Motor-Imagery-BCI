function [cnt_f] = myHighLapfilter(cnt, points, ch)
for n = 1:length(ch)
    ...
    %%
    [dis,ind] = sort(dis);
    neighbors_candid = points(:, ind(10:21));
    candid_ind = ind(10:21);
    candid_dis = dis(10:21);
    ...
    % %     plot(neighbors_candid(1,:),neighbors_candid(2,:),'sg',...
